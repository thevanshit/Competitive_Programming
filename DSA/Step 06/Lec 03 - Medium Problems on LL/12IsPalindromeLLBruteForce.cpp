#include <iostream>
#include <stack> // Replaced <bits/stdc++.h> with the specific header needed.
...
bool isPalindrome(Node* head) {
    ...
    // --- First Pass: Traverse the linked list and push values onto the stack ---
    while (temp != NULL) {
        st.push(temp->data); // Push the data from the current node
    ...
    // --- Second Pass: Compare values by popping from the stack ---
    while (temp != NULL) {
        if (temp->data != st.top()) {
